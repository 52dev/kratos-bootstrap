...
const file_conf_v1_kratos_conf_logger_proto_rawDesc = "" +
	...
	"\n" +
	"\b_zerologB\x87\x01\n" +
	"\bcom.confB\x15KratosConfLoggerProtoP\x01Z4github.com/52dev/kratos-bootstrap/api/gen/go/conf/v1\xa2\x02\x03CXX\xaa\x02\x04Conf\xca\x02\x04Conf\xe2\x02\x10Conf\\GPBMetadata\xea\x02\x04Confb\x06proto3"
